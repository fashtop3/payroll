...
<head>
    ...
    <title> Payroll::Access Denied </title>
...
<img src="{{asset('assets/image-resources/blurred-bg/blurred-bg-4.jpg')}}" class="login-img wow fadeIn" alt="">
    ...
    <div class="center-content row">
        ...
        <div class="col-md-6 center-margin">
            <div class="server-message wow bounceInDown inverse">
                ...
                <p>Page Restriction. go back to <a href="{{route('dashboard')}}">Dashboard</a></p>
            </div>
        </div>
