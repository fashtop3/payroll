                        ...
                        @if($profiles)
                            @forelse($profiles as $profile)
                                <tr>
                                    ...
                                    <td><a target="_blank" href="{{route('report.payslip.upc', $profile->id)}}?action=print" class="btn btn-xs btn-info">Print PayCarf</a></td>
                                    <td><a target="_blank" href="{{route('report.payslip.ups', $profile->id)}}?action=print" class="btn btn-xs btn-primary">Print PaySlip</a></td>
                                </tr>
                            @endforeach
                        @endif
